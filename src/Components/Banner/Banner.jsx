...
import SearchCard from "../SearchCard/Search.Card";
...
const Banner = ({handleSearch}) => {
  ...
  return (
    <div className="flex justify-center items-center h-80">
      <div className="bg-[url(https://i.ibb.co/tPz3tK9/Rectangle-4281.png?fbclid=IwAR2NBwfDCkiqEsYvwH7XU4DncCodQZZ34f3ILeWty0nbKGW4r4MPa7atIfU)] w-full h-[600px] absolute top-0 flex  justify-center  bg-cover bg-no-repeat items-center opacity-10  "></div>
