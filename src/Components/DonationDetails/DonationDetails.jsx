    ...
    <div className="w-full my-10">
      ...
      <div className="w-9/12 mx-auto ">
        <div className="relative mx-auto">
          <img
            className="md:w-10/12 lg:w-9/12 
            lg:rounded-b-2xl mx-auto rounded-lg md:roundedb-2xl "
            src={picture}
            alt=""
          />
          ...
          <button
            ...
            className=" absolute z-30 md:bottom-5 bottom-3 lg:bottom-5 left-5 lg:left-52 md:left-20 py-2 px-4 rounded text-white font-light"
          >
            Donate ${price}
          </button>
        </div>
